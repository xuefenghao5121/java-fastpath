...
public class BigDecimal extends Number implements Comparable<BigDecimal> {
   ...
   private void writeObject(java.io.ObjectOutputStream s)
    ...
    /**
     * Check if divisor is small (2-5 digits) for fast divide.
     */
    ...
    /**
     * Check if divide can use fast path.
     */
    ...
    /**
     * Check if divide can use fast path with scale difference.
     */
    ...
    /**
     * Helper to create divide result with proper scale adjustment.
     */
